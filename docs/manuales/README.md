# Manuales de uso de Stoka LMS

Guías escritas para personas que USAN la plataforma — estudiantes, docentes, coordinadores y
administradores — sin necesitar conocimientos técnicos ni de programación. Si buscás documentación
técnica (arquitectura, cómo levantar el entorno de desarrollo, decisiones de diseño), esa está en
[`docs/architecture/`](../architecture/README.md) y en el [`README.md`](../../README.md) de la raíz
del proyecto.
